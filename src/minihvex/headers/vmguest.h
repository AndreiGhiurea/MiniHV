...
// NOTE: These controls will be OR'ed with the necessary
// default1 bits
#define VM_CONTROL_SECONDARY_PROC_BASED_CTLS        (PROC_BASED_SECONDARY_ENABLE_EPT | PROC_BASED_SECONDARY_UNRESTRICTED_GUEST | PROC_BASED_SECONDARY_ENABLE_INVPCID)
